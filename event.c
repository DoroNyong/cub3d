...
/*   Updated: 2025/10/29 02:10:10 by hjang            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void draw_vertical_line(t_sl *sl, int x)
{
	...
	sl->draw.step = 1.0 * sl->texture[sl->draw.tex_dir * 3 + sl->anim.corrent_frame].height / sl->draw.line_height;
    ...
    {
		sl->draw.tex_y = (int)sl->draw.tex_pos % sl->texture[sl->draw.tex_dir * 3 + sl->anim.corrent_frame].height;
		sl->draw.tex_pos += sl->draw.step;

		sl->draw.tex_pixel = sl->texture[sl->draw.tex_dir * 3 + sl->anim.corrent_frame].addr + (sl->draw.tex_y * sl->texture[sl->draw.tex_dir * 3 + sl->anim.corrent_frame].line_length + sl->draw.tex_x * (sl->texture[sl->draw.tex_dir * 3 + sl->anim.corrent_frame].bits_per_pixel / 8));
...
void	make_screen(t_sl *sl)
{
	...
	while (x < sl->data.screen_width)
	{
		...
		sl->draw.tex_x = (int)(sl->draw.wall_x * (double)sl->texture[sl->draw.tex_dir * 3 + sl->anim.corrent_frame].width);
		if (sl->draw.side == 0 && sl->draw.ray_dir_x < 0)
			sl->draw.tex_x = sl->texture[sl->draw.tex_dir * 3 + sl->anim.corrent_frame].width - sl->draw.tex_x - 1;
